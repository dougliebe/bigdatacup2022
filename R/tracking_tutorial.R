...
tracking_data_player_count = 
  tracking_data_nested %>%
...
source(here::here("Big-Data-Cup-2021-main/Big-Data-Cup-2021-main/OTTHAC_Tutorial","Code/plot_rink.R"))
...
p2 = animate(p, fps = 30, duration = (max_frame - min_frame)/30 + 1)


# Save as an mp4
anim_save(here::here("Big-Data-Cup-2021-main/Big-Data-Cup-2021-main/OTTHAC_Tutorial","Figures/demo.mp4"), p2)